...
public class HIvrService extends HApiUtil {
	...
	private static final String PARAM_ON_FAILURE = "on_failure";
	 ...
	 */
	public static Map<String, Object> dial(boolean secure, String appId, String accessToken,
			String dest, String msg, String callerID, String tag,
		...
		return post(secure, URL_IVR_DIAL, map);
	}
	 ...
	 * @throws HoiioException
	 */
	public static Map<String, Object> play(boolean secure, String appId, String accessToken,
			String session, String msg, String tag, String notifyUrl)
			throws HoiioException {
		HashMap<String, String> map = new HashMap<String, String>();
		map.putAll(initParam(appId, accessToken));
		...
		return post(secure, URL_IVR_PLAY, map);
	}
	 ...
	 * @throws HoiioException
	 */
	public static Map<String, Object> gather(boolean secure, String appId, String accessToken,
			String session, String msg, Integer maxDigits, Integer timeout,
			Integer attempts, String tag, String notifyUrl)
			throws HoiioException {
		HashMap<String, String> map = new HashMap<String, String>();
		map.putAll(initParam(appId, accessToken));
	 ...
	 * @throws HoiioException
	 */
	public static Map<String, Object> record(boolean secure, String appId, String accessToken,
			String session, String msg, String maxDuration, String tag,
			String notifyUrl) throws HoiioException {
		HashMap<String, String> map = new HashMap<String, String>();
		map.putAll(initParam(appId, accessToken));
		...
		return post(secure, URL_IVR_RECORD, map);
	}
	 ...
	 * @throws HoiioException
	 */
	public static Map<String, Object> transfer(boolean secure, String appId,
			String accessToken, String session, String msg, String dest,
			String callerID, OnFailure onFailure, String tag, String notifyUrl)
			throws HoiioException {
		HashMap<String, String> map = new HashMap<String, String>();
		map.putAll(initParam(appId, accessToken));
		...
		map.put(PARAM_NOTIFY_URL, notifyUrl);
		map.put(PARAM_MSG, msg);
		map.put(PARAM_ON_FAILURE, onFailure.toString().toLowerCase());
		map.put(PARAM_TAG, tag);
		map.put(PARAM_DEST, dest);
		map.put(PARAM_CALLER_ID, callerID);

		return post(secure, URL_IVR_TRANSFER, map);
	}
	...
	public static Map<String, Object> hangup(boolean secure, String appId, String accessToken,
		...
		return post(secure, URL_IVR_HANGUP, map);
	}
}
